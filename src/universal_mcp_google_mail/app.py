...
class GoogleMailApp(APIApplication):
    ...
    def send_email(self, to: str, subject: str, body: str) -> dict[str, Any]:
        ...
        Tags:
            send, email, api, communication, important, destructiveHint"""
    ...
    def create_draft(self, to: str, subject: str, body: str) -> dict[str, Any]:
        ...
        Tags:
            create, email, draft, gmail, api, important, readOnlyHint"""
    ...
    def send_draft(self, draft_id: str) -> dict[str, Any]:
        ...
        Tags:
            send, email, api, communication, important, draft, destructiveHint"""
    ...
    def get_draft(self, draft_id: str, format: str = "full") -> dict[str, Any]:
        ...
        Tags:
            retrieve, email, gmail, draft, api, format, important, readOnlyHint"""
    ...
    def list_drafts(
        ...
        Tags:
            list, email, drafts, gmail, api, search, query, pagination, important, readOnlyHint
        """
        url = f"{self.base_api_url}/drafts"
    ...
    def get_message(self, message_id: str) -> GmailMessage:
        ...
        Tags:
            retrieve, email, format, api, gmail, message, important, body, content, readOnlyHint
        """
    ...
    def list_messages(
        ...
        Tags:
            list, messages, gmail, search, query, pagination, important, readOnlyHint"""
    ...
    def list_labels(self) -> dict[str, Any]:
        ...
        Tags:
            list, gmail, labels, fetch, organize, important, management, readOnlyHint"""
    ...
    def create_label(self, name: str) -> dict[str, Any]:
        ...
        Tags:
            create, label, gmail, management, important, destructiveHint"""
        url = f"{self.base_api_url}/labels"
        label_data = {
            "name": name,
    ...
    def get_profile(self) -> dict[str, Any]:
        ...
        Tags:
            fetch, profile, gmail, user-info, api-request, important, readOnlyHint"""
    ...
    def get_vacation_settings(
        ...
        Tags:
            settings, vacation, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def update_vacation_settings(
        ...
        Tags:
            settings, vacation, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        request_body = {
    ...
    def get_language_settings(
        ...
        Tags:
            settings, language, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def get_auto_forwarding_settings(
        ...
        Tags:
            settings, autoForwarding, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def update_auto_forwarding(
        ...
        Tags:
            settings, autoForwarding, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        request_body = {
    ...
    def set_default_smime_config(
        ...
        Tags:
            settings, Send As, Send As Email, SMIME INFO, Set Default, destructiveHint
        """
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def get_send_as_smime_info(
        ...
        Tags:
            settings, Send As, Send As Email, SMIME INFO, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if sendAsEmail is None:
            raise ValueError("Missing required parameter 'sendAsEmail'")
    ...
    def delete_send_as_smime_info(
        ...
        Tags:
            settings, Send As, Send As Email, SMIME INFO, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if sendAsEmail is None:
            raise ValueError("Missing required parameter 'sendAsEmail'")
    ...
    def verify_send_as(
        ...
        Tags:
            settings, Send As, Send As Email, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if sendAsEmail is None:
            raise ValueError("Missing required parameter 'sendAsEmail'")
    ...
    def get_send_as(
        ...
        Tags:
            settings, Send As, Send As Email, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if sendAsEmail is None:
            raise ValueError("Missing required parameter 'sendAsEmail'")
    ...
    def create_send_as(
        ...
        Tags:
            settings, Send As, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        request_body = {
            "displayName": displayName,
    ...
    def get_cse_keypairs(
        ...
        Tags:
            settings, CSE Identites, Key Pairs, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def create_cse_keypairs(
        ...
        Tags:
            settings, CSE Identites, Key Pairs, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        request_body = {
    ...
    def list_cse_identites(
        ...
        Tags:
            settings, CSE Identites, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def create_cse_identites(
        ...
        Tags:
            settings, CSE Identites, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        request_body = {
            "emailAddress": emailAddress,
    ...
    def delete_filters(
        ...
        Tags:
            settings, Filters, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if id is None:
            raise ValueError("Missing required parameter 'id'")
    ...
    def get_forwarding_addresses(
        ...
        Tags:
            settings, Forwarding Addresses, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def delete_forwarding_addresses(
        ...
        Tags:
            settings, Forwarding Addresses, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if forwardingEmail is None:
            raise ValueError("Missing required parameter 'forwardingEmail'")
    ...
    def get_delegates(
        ...
        Tags:
            settings, Delegates, readOnlyHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
    ...
    def delete_delegates(
        ...
        Tags:
            settings, Delegates, destructiveHint"""
        if userId is None:
            raise ValueError("Missing required parameter 'userId'")
        if delegateEmail is None:
            raise ValueError("Missing required parameter 'delegateEmail'")
