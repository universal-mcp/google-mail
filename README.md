...
You can start using Google-Mail directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Google-Mail.
...
The full list of available tools is at [./src/universal_mcp_google_mail/README.md](./src/universal_mcp_google_mail/README.md)
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_google_mail/mcp.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_google_mail/mcp.py
   ```
